...
alter table if exists acl_adminrule_priority
   add constraint fk_adminrule_priority_adminrule
   foreign key (id)
   references acl_adminrule;
...
alter table if exists acl_rule_priority
   add constraint fk_rule_priority_rule
   foreign key (id)
   references acl_rule;
