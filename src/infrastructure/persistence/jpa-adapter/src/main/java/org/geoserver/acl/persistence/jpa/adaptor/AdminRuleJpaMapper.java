...
public interface AdminRuleJpaMapper {
    static final String ANY = org.geoserver.acl.persistence.jpa.domain.JpaAdminRuleIdentifier.ANY;
    ...
    public abstract AdminRuleIdentifier toModel(org.geoserver.acl.persistence.jpa.domain.JpaAdminRuleIdentifier i);
    ...
    public abstract org.geoserver.acl.persistence.jpa.domain.JpaAdminRuleIdentifier toEntity(AdminRuleIdentifier i);

    public abstract AdminRule toModel(org.geoserver.acl.persistence.jpa.domain.JpaAdminRule entity);

    @Mapping(target = "createdBy", ignore = true)
    @Mapping(target = "createdDate", ignore = true)
    @Mapping(target = "lastModifiedBy", ignore = true)
    @Mapping(target = "lastModifiedDate", ignore = true)
    public abstract org.geoserver.acl.persistence.jpa.domain.JpaAdminRule toEntity(AdminRule model);
    ...
    @Mapping(target = "lastModifiedBy", ignore = true)
    @Mapping(target = "lastModifiedDate", ignore = true)
    void updateEntity(@MappingTarget org.geoserver.acl.persistence.jpa.domain.JpaAdminRule entity, AdminRule model);
}
