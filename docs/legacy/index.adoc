...
https://en.wikipedia.org/wiki/Fork_%28software_development%29[fork] of 
https://github.com/geoserver/geofence[GeoFence].
...
* link:users-guide/index.html[User's Guide] - Complete guide to installing, configuring, and using GeoServer ACL
* link:developers-guide/index.html[Developer's Guide] - Guide for developers working with the codebase
* link:technical/index.html[Technical Documentation] - Architecture and design documentation (arc42 format)
* link:management.html[Management API] - Information about management endpoints
* link:api/index.html[API Documentation] - OpenAPI specification for the REST API
