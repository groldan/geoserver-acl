...
If you're currently using GeoFence, GeoServer ACL follows a similar approach to access control. The main differences are:

- Improved API design
- Better performance
- Enhanced integration capabilities
- Support for GeoServer Cloud

See the [Migration from GeoFence](geofence_migration.md) section for detailed migration instructions.

## Next Sections

- [Installation](installation.md) - How to install GeoServer ACL
- [Configuration](configuration.md) - Basic configuration options
- [Rule Management](rule_management.md) - Creating and managing data access rules
- [Admin Rule Management](admin_rule_management.md) - Setting up workspace administration
- [Spatial & Attribute Filtering](filtering.md) - Configuring detailed access restrictions
- [REST API Usage](rest_api.md) - Using the REST API for automation
- [Monitoring](monitoring.md) - Monitoring and auditing access
- [Migration from GeoFence](geofence_migration.md) - Migrating from GeoFence to GeoServer ACL